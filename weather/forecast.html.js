export default `<div id="wrapper" class="forecast inline-block overflow-x-auto">
	<table class="overflow-x-auto">
		...
		<thead>
			<tr>
				<th class="cell dow"><slot name="dow1">Sunday</slot></th>
				<th class="cell dow"><slot name="dow2">Monday</slot></th>
				<th class="cell dow"><slot name="dow3">Tuesday</slot></th>
				<th class="cell dow"><slot name="dow4">Wednesday</slot></th>
				<th class="cell dow"><slot name="dow5">Thursday</slot></th>
			</tr>
		</thead>
		<tbody>
			<tr>
				<td class="cell day">
					...
					<div class="forecast-icon center">
						<slot name="icon1">
							<svg class="current-color" viewbox="0 0 16 16" fill="currentColor" height="84" width="84">
								<use xlink:href="#weather-clear"></use>
							</svg>
						</slot>
					</div>
					<div class="summary center capitalize">
						<slot name="summary1">Unknown</slot>
					</div>
					<hr />
					<span class="high-low high" title="Forecasted High"><slot name="high1">?</slot>&deg;</span>
					<span class="high-low low" title="Forecasted Low"><slot name="low1">?</slot>&deg;</span>
				</td>
				<td class="cell day">
					<div class="date center">
					...
					<div class="summary center capitalize">
						<slot name="summary2">Unknown</slot>
					</div>
					<hr />
					<span class="high-low high" title="Forecasted High"><slot name="high2">?</slot>&deg;</span>
					<span class="high-low low" title="Forecasted Low"><slot name="low2">?</slot>&deg;</span>
				</td>
				<td class="cell day">
					<div class="date center">
						<slot name="date3"></slot>
					</div>
					<div class="forecast-icon center">
						<slot name="icon3">
							<svg class="current-color" viewbox="0 0 16 16" fill="currentColor" height="84" width="84">
					...
					<div class="summary center capitalize">
						<slot name="summary3">Unknown</slot>
					</div>
					<hr />
					<span class="high-low high" title="Forecasted High"><slot name="high3">?</slot></span>
					<span class="high-low low" title="Forecasted Low"><slot name="low3">?</slot>&deg;</span>
				</td>
				<td class="cell day">
					<div class="date center">
						<slot name="date4"></slot>
					</div>
					<div class="forecast-icon center">
						<slot name="icon4">
							<svg class="current-color" viewbox="0 0 16 16" fill="currentColor" height="84" width="84">
					...
					<div class="summary center capitalize">
						<slot name="summary4">Unknown</slot>
					</div>
					<hr />
					<span class="high-low high" title="Forecasted High"><slot name="high4">?</slot>&deg;</span>
					<span class="high-low low" title="Forecasted Low"><slot name="low4">?</slot>&deg;</span>
				</td>
				<td class="cell day">
					<div class="date center">
						<slot name="date5"></slot>
					</div>
					<div class="forecast-icon center">
						<slot name="icon5">
							<svg class="current-color" viewbox="0 0 16 16" fill="currentColor" height="84" width="84">
					...
					<div class="summary center capitalize">
						<slot name="summary5">Unknown</slot>
					</div>
					<hr />
					<span class="high-low high" title="Forecasted High"><slot name="high5">?</slot>&deg;</span>
					<span class="high-low low" title="Forecasted Low"><slot name="low5">?</slot>&deg;</span>
				</td>
			</tr>
		</tbody>
		<tfoot>
			<tr>
				<th colspan="5">
					...
					<a href="https://openweathermap.org" rel="noopener external" class="color-inherit">OpenWeatherMap</a>
				</th>
			</tr>
		</tfoot>
	</table>
...
<svg xmlns="http://www.w3.org/2000/svg" hidden="">
	<symbol height="84" width="84" id="weather-clear" viewBox="0 0 16 16">
	...
	<symbol height="84" width="84" id="weather-clear-night" viewBox="0 0 16 16">
	...
	<symbol height="84" width="84" id="weather-few-clouds" viewBox="0 0 16 16">
	...
	<symbol height="84" width="84" id="weather-few-clouds-night" viewBox="0 0 16 16">
	...
	<symbol height="84" width="84" id="weather-fog" viewBox="0 0 16 16">
	...
	<symbol height="84" width="84" id="weather-overcast" viewBox="0 0 16 16">
	...
	<symbol height="84" width="84" id="weather-severe-alert" viewBox="0 0 16 16">
	...
	<symbol height="84" width="84" id="weather-showers" viewBox="0 0 16 16">
	...
	<symbol height="84" width="84" id="weather-showers-scatterd" viewBox="0 0 16 16">
	...
	<symbol height="84" width="84" id="weather-snow" viewBox="0 0 16 16">
	...
	<symbol height="84" width="84" id="weather-storm" viewBox="0 0 16 16">
	...
	<symbol height="84" width="84" id="weather-windy" viewBox="0 0 16.022 16.009">
