...
import { createDialogPasswordIcon, createCheckIcon, createXIcon } from '@shgysk8zer0/kazoo/icons.js';
import { updatePassword, reauthenticateWithCredential, EmailAuthProvider } from 'firebase/firebase-auth.js';
				...
				submit: async event => {
					...
					try {
						...
						if (typeof auth.currentUser === 'object' && ! Object.is(auth.currentUser, null)) {
							await updatePassword(auth.currentUser, data.get('newPassword'));
...
customElements.define('firebase-change-password', HTMLFirebaseVerifyEmailFormElement);
